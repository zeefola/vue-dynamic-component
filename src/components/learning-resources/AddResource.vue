<template>
  <base-dialog v-if="inputIsInvalid" title="Invalid Input" @close="confirmError"> <!-- Check if inputIsValid is true and set value for title and custom event(close) on click-->
    <template #default>
